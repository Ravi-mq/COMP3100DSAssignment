...
This stage looks into the working of server and client using simulator. Main focus is to have a working client scheduler which can allocate jobs efficiently using Largest-Round-Robin (LRR) algorithm.
Brief introduction of your stage...
...
\bibliography{COMP3100 - Project Report template/citations}
